<html>
	...
	<body>
		...
		<div id="upload">
			...
			<form action="<?php t(MAIN_FILE) ?>/admin/member_image_upload?target=<?php t($view['target']) ?><?php !empty($_GET['id']) ? t('&id=' . intval($_GET['id'])) : '' ?>" method="post" enctype="multipart/form-data">
