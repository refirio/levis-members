<?php import('app/views/header.php') ?>
        ...
        <form action="<?php t(MAIN_FILE) ?>/register/form" method="post" class="register validate">
            <fieldset>
                ...
                <dl>
                    <dt>暗証コード</dt>
                        <dd><input type="text" name="token_code" size="30" value="<?php t($_view['user']['token_code']) ?>" /></dd>
                    <dt>ユーザ名</dt>
                    ...
                    <dt>メールアドレス</dt>
                        <dd><input type="text" name="email" size="30" value="<?php t($_view['key']) ?>" disabled="disabled" /></dd>
                </dl>
